#!/bin/bash
#SBATCH --job-name=train-mmc-tasks-img
...
########################################################
# already ran: CNN3DSeqMeanPool CNN3DSeqReducedMeanPool CNN3DSeqMeanStdPool CNN3DSeqReducedMeanStdPool CNN3DSeqAttnPool
for modelName in  CNN3DSeqReducedAttnPool CNN3DSeqLSTM CNN3DSeqReducedLSTM CNN2DSeqReducedMeanStdPool CNN2DSeqReducedAttnPool CNN2DSeqMeanStdPool CNN2DSeqAttnPool CNN2DSeqReducedLSTM CNN2DSeqLSTM; do

    srun python3 covidecg/train.py --model $modelName --feats img data/processed/mmc_tasks_img/mmc_covid_vs_ctrl610
