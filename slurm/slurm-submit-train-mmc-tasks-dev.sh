#!/bin/bash
#SBATCH --job-name=train-mmc-tasks-dev
...
# CNN3DSeqMeanPool CNN3DSeqReducedMeanPool CNN3DSeqMeanStdPool CNN3DSeqReducedMeanStdPool CNN3DSeqAttnPool CNN3DSeqReducedAttnPool CNN3DSeqLSTM CNN3DSeqReducedLSTM

for modelName in CNN2DSeqReducedMeanStdPool CNN2DSeqReducedAttnPool CNN2DSeqMeanStdPool CNN2DSeqAttnPool CNN2DSeqReducedLSTM CNN2DSeqLSTM; do

    # run on mmc data development samples
    srun python3 covidecg/train.py --model $modelName --feats raw data/processed/mmc_tasks_raw/mmc_covid20_vs_ctrl20
    srun python3 covidecg/train.py --model $modelName --feats img data/processed/mmc_tasks_img/mmc_covid20_vs_ctrl20
    srun python3 covidecg/train.py --model $modelName --feats lfcc data/processed/mmc_tasks_lfcc/mmc_covid20_vs_ctrl20
