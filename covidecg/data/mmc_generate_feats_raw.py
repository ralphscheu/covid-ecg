...
def main(input_dir, output_dir, prefix, min_length, max_length, sampling_rate):
    ...
    for file in tqdm(files, desc="Processing files"):
        ...
        for recording_counter, recording in enumerate(root.findall('component/series', namespaces)):
            ...
            if ecg_length < min_length:
                continue
            elif ecg_length > max_length:
                rec_df = rec_df.iloc[0:max_length]
