...
#     data/raw/ecg_export_postcovid data/interim/mmc_recs_csv/postcovid

# # Extract all recordings for control group
# rm -rf data/interim/mmc_recs_csv/ctrl
# python3 covidecg/data/extract_recordings.py \
#     --prefix ctrl \
#     --patients-list data/raw/patients_ctrl.csv \
#     data/raw/ecg_export_ctrl data/interim/mmc_recs_csv/ctrl
...
# #     data/interim/mmc_recs/postcovid data/interim/mmc_sessions_postcovid

# # python3 covidecg/data/concat_recordings_per_session.py \
# #     --recordings-list data/interim/recordings_stress_ecg_ctrl.csv \
# #     data/interim/mmc_recs/ctrl data/interim/mmc_sessions_ctrl
