...
# ABNORMAL HEARTBEAT
for file in ./data/external/ECG\ Images\ of\ Patient\ that\ have\ abnormal\ heart\ beats\ \(548\)/*.jpg; do
    echo "Processing ${file}"
    python3 covidecg/data/load_khan2021_dataset.py --img-height 100 \
...
for file in ./data/external/abnormal_heartbeat_ecgsheet2/*.jpg; do
    echo "Processing ${file}"
    python3 covidecg/data/load_khan2021_dataset.py --img-height 100 \
        --output-dir data/interim/_khan2021_abnormal \
